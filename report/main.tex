...
\subsection{AdaBoost}
Fron this section on we'll discuss about various boosting models.
...
We should apply a more rigorous validation on Blending or at least chose one model such as DNN with good validation score. \\
