...
X_test_path = os.path.join(os.path.dirname(__file__), 'preprocess/X_test2.pkl')
...
if __name__ == '__main__':
    ...
    submission_path = os.path.join(os.path.dirname(__file__), f'submissions/{model_name}_submissions_stage2.csv')
